...
public class BoundPropertyDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        /*
         * A label with huge text that can grow to fill the entire available
         * area.
         */
        ...
        /*
         * The label is the center component of a BorderPane, which is the scene
         * graph root.
         */
         ...
         * value of type Background that is equal to the pink background when
         * the
         ...
         * observable value, so that the checkbox will control the label
         * background.
         */
         ...
         * label's textProperty is bound to a string property that is derived
         * from
        ...
        /*
         * Make a menubar with a Color menu containing a radiogroup for setting
         * the color
         * of the text in the label. Make a corresponding group of radio buttons
         * and put
         * them in a VBox at the right of the BorderPane. Bidirectionally bind
         * the radio
         * buttons to the radio menu items, to keep the selection in the menu in
         * synch
         * with the selection in the group of buttons. Only the menu items are
         * added
